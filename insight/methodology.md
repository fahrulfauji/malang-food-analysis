...
| Subdistrict | Restaurant district location |
| Menu Item | Name of the menu item |
| Menu Reviews | Number of reviews mentioning the menu |
| Total Reviews | Total reviews of the restaurant |
| Rating | Google Maps rating score |
| Price Range | Average menu price range |
...
- price validation,
- and category consistency checks.
...
- and basic exploratory visualization.
...
- and summary statistic generation.
